...
input_workbook = xl.load_workbook('yt_details.xlsx')  # Replace with your file path
input_sheet = input_workbook['Sheet22']
...
while True:
    ...
    output_sheet.cell(row=row_index, column=2).value = insert_response['id']
    output_sheet.cell(row=row_index, column=3).value = live_stream_link
